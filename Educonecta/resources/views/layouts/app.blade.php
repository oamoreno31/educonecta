...
<body class="index-page">
    ...
    <main class="py-4" style="margin-top:100px;">@yield('content')</main>
    ...
    <script src="/UProyecto/Educonecta/public/assets/js/soft-design-system.min.js?v=1.0.9" type="text/javascript"></script>
