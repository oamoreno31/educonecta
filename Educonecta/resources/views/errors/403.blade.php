  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">¡Ups! No tienes acceso a la URL solicitada</p>
        <a href=" {{ route('home') }} " class="btn btn-primary">Volver al Inicio</a>
        <div class="mt-3">
          <img
            src="{{ asset('assets/assets/img/illustrations/error-403-forbidden.png')}}"
            alt="error-403-forbidden"
            width="700"
            class="img-fluid"
            data-app-dark-img="illustrations/page-misc-error-dark.png"
            data-app-light-img="illustrations/error-403-forbidden.png"
          />
        </div>
      </div>
    </div>
